...
const HeroSection = ({ scrollToSection }) => {
  ...
  <div className="max-w-6xl mx-auto w-full">
    {/* Change grid to 2 columns always */}
    <div className="grid grid-cols-2 gap-6 items-center">
      ...
      <div className="text-white space-y-6">
        ...
        <p className="text-xl md:text-2xl text-purple-100">Passionate Web Developer</p>
        <p className="text-lg text-purple-100 leading-relaxed">
          I craft beautiful, responsive websites and web applications that deliver
          exceptional user experiences. Let's bring your ideas to life with modern web
          technologies.
        </p>
      ...
      <div className="flex justify-center">
        <div
          className="relative group w-full max-w-[320px] h-[400px] rounded-full overflow-hidden border-4 border-yellow-400 shadow-2xl ring-4 ring-yellow-300/30 transform transition duration-500 hover:scale-105"
          ...
          {[...Array(3)].map((_, i) => (
            <div
              ...
              className={`absolute w-4 h-4 bg-white/30 rounded-full animate-ping ${
                i === 0 ? 'top-6 left-6' : i === 1 ? 'bottom-10 right-6' : 'bottom-6 left-12'
              }`}
              style={{
                animationDelay: `${i}s`,
